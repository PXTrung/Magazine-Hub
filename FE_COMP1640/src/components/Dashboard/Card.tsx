...
interface ICardProps {
   label: string;
   value: string;
   icon: "top" | "total-contributions" | "total-published" | "feedback";
}
      ...
      <div className="bg-white shadow w-full h-28 rounded-lg px-5 py-5 hover:shadow-md transition-all duration-200">
         <div className="flex flex-col justify-between h-full">
            ...
            <div className="flex justify-between items-center">
               ...
               {data.icon === "top" && (
                  <div className="bg-amber-200 w-9 h-9 flex justify-center items-center rounded-md">
                     <svg
               ...
               {data.icon === "total-contributions" && (
                  <div className="bg-emerald-200 w-9 h-9 flex justify-center items-center rounded-md">
                     <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
               ...
               {data.icon === "total-published" && (
                  <div className="bg-blue-200 w-9 h-9 flex justify-center items-center rounded-md">
                     <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
               ...
               {data.icon === "feedback" && (
                  <div className="bg-violet-200 w-9 h-9 flex justify-center items-center rounded-md">
                     <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
