...
const HeroSection = () => {
   return (
      <div className="relative w-full h-[500px] mt-15 lg:mt-24 overflow-hidden flex flex-col justify-center items-center">
         ...
         />
         <div className="h-full w-full md:w-full lg:w-[960px] xl:w-[1200px] flex flex-col justify-center items-center z-20 text-white text-center">
            ...
            <span className="font-normal px-4 mb-10 md:px-20 lg:px-64 text-sm md:text-base">
               ...
               assumenda at mollitia beatae repellendus? Quod, mollitia! Commodi
               consequatur, deserunt aliquid alias aliquam sapiente?
            </span>
