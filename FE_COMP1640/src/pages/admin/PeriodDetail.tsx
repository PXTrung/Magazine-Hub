  ...
  return (
    <div className="w-[600px] flex flex-col mt-20">
      ...
      <div className="text-left w-full">
        {isSucess && <span className="text-green-600">{message}</span>}
        ...
        >
          <div className="mb-6">
            ...
            <input
              ...
              type="date"
              defaultValue={formDate(selectedPeriod?.firstSubmissionDeadline)}
          ...
          <div className="mb-6">
            ...
            <input
              ...
              type="date"
              defaultValue={formDate(selectedPeriod?.secondSubmissionDeadline)}
